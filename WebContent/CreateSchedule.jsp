...
<body>
	...
	<div class="container-fluid">
		...
		<div class="form_create_schedule">
			<form id="form_create_schedule" class="form"
				action="createscheduleservlet.do" method="post" novalidate>
				<br />
				<p>Schedule name :</p>
				<input type="text" name="fileset_name" placeholder="schedule name"
					required /><br />
				<br />
				<p>Run time :</p>
				<input type="text" name="backup_folder_path" placeholder="run time"
					required /><br />
				<br />
				<p></p>
				<br />
				<br /> <br /> <br /> <br /> <br /> <br /> <input type="submit"
					id="submit" name="submit_fileset" value="Create" /> <br /> <br />
			</form>
		</div>
	</div>
</body>
